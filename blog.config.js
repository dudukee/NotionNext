...
const BLOG = {
  ...
  SINCE: parseInt(process.env.NEXT_PUBLIC_SINCE) || 2021, // e.g if leave this empty, current year will be used.
  ...
  ANALYTICS_BUSUANZI_ENABLE: process.env.NEXT_PUBLIC_BUSUANZI_ENABLE || true, // 展示网站阅读量、访问数 see http://busuanzi.ibruce.info/
